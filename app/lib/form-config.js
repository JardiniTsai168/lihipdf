...
export const FIELD_HINTS = {
  applicationDate: "dummy-date",
  ownerName: "dummy-owner-name",
  principalName: "dummy-principal-name",
  ownerPhone: "dummy-owner-phone",
  ownerAddress: "dummy-owner-address",
  siteAddress: "dummy-site-address",
  contactPerson: "dummy-contact-name",
  contactPhone: "dummy-contact-phone",
  contactAddress: "dummy-contact-address",
  caseNumber: "dummy-case-number",
  districtOffice: "dummy-district-office",
  electricNumber: "dummy-electric-number",
  installedExisting: "dummy-existing-kw",
  installedNew: "dummy-new-kw",
  installedTotal: "dummy-total-kw",
  saleExisting: "dummy-existing-sale-kw",
  saleNew: "dummy-new-sale-kw",
  saleTotal: "dummy-total-sale-kw",
  contractCapacity: "dummy-contract-kw",
  parallelMethod: "dummy-parallel-method",
  saleMode: "dummy-sale-mode",
  innerLineNumber: "dummy-inner-line-number",
  contractType: "dummy-contract-type",
  estimatedParallelDate: "dummy-estimated-date",
  companyName: "dummy-company-name",
  companyContactPerson: "dummy-company-contact",
  companyPhone: "dummy-company-phone",
  companyAddress: "dummy-company-address",
  companyTaxId: "dummy-company-tax-id",
  detailReviewDate: "dummy-detail-review-date",
  externalDesignDate: "dummy-external-design-date",
  otherNotes: "dummy-other-notes"
};
